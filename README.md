...
## Déploiement local
Vous ne pourrez pas tester les endpoints, car cela nécessitera une configuration complète de MariaDB. Cependant, suivez les instructions ci-dessous pour explorer la documentation de l’API en local.
